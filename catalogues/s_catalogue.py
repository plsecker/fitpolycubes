...
class SCatalogue(Catalogue):
    def impossible_reason(self, box: Box) -> str | None:
        ...
        if a == 4 and b == 9 and c ==15: # needs the 22th pentacubes.
            return "published_impossible"
        if a == 4 and b == 10 and c ==14: # needs the 22th pentacubes.
            return "published_impossible"
        if a == 5 and b == 7 and c ==30: # needs the 22th pentacubes.
            return "published_impossible"
