...
/* Include files */
#include "_coder_place_mex_info.h"
...
mxArray *emlrtMexFcnProperties()
{
  ...
  xInputs = mxCreateLogicalMatrix(1, 4);
  mxSetFieldByNumber(xEntryPoints, 1, 0, mxCreateString("reject"));
  mxSetFieldByNumber(xEntryPoints, 1, 1, mxCreateDoubleScalar(4));
...
/* End of code generation (_coder_place_mex_info.c) */
